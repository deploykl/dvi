...
<div class="container">
	<div class="left-section">
		<div class="inner-content">
			...
			<p class="subheading text-light">Lo sentimos, la página que buscas no existe.</p>
      <div class="text-center mt-3">
      <router-link to="/" class="btn btn-danger"><i class="fas fa-home"></i> Volver a inicio</router-link>
    </div>
		</div>
	</div>
...
<script setup>
// No es necesario usar script para esta solución, a menos que necesites lógica adicional.
</script>
